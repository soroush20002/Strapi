...
export interface ApiSupResponseSupResponse extends Struct.CollectionTypeSchema {
  collectionName: 'sup_responses';
  info: {
    description: '';
    displayName: 'sup-response';
    pluralName: 'sup-responses';
    singularName: 'sup-response';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sup-response.sup-response'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rText: Schema.Attribute.Text;
    ui: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    sups: Schema.Attribute.Relation<'manyToMany', 'api::sup.sup'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_carts: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sup-response.sup-response': ApiSupResponseSupResponse;
      'api::sup.sup': ApiSupSup;
